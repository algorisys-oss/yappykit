...
const STATIC_ROUTES: Record<Exclude<RouteKey, BuildKey | CategoryKey>, RouteDef> = {
  ...
  'video-mute': {
    ...
    slugs: {
      en: 'mute-a-video',
      es: 'quitar-el-sonido-de-un-video',
      'pt-BR': 'tirar-o-som-de-um-video',
      id: 'hapus-suara-video',
      fr: 'couper-le-son-dune-video',
      de: 'ton-aus-video-entfernen',
      ru: 'ubrat-zvuk-iz-video',
      tr: 'videonun-sesini-kaldir',
      vi: 'tat-tieng-video',
      it: 'togliere-audio-da-un-video',
    },
  },
  'video-extract-audio': {
    localized: true,
    slugs: {
      ...
      es: 'extraer-audio-de-un-video',
      'pt-BR': 'extrair-audio-de-video',
      id: 'ambil-audio-dari-video',
      fr: 'extraire-le-son-dune-video',
      de: 'audio-aus-video-extrahieren',
      ru: 'izvlech-zvuk-iz-video',
      tr: 'videodan-ses-cikar',
      vi: 'tach-am-thanh-tu-video',
      it: 'estrarre-audio-da-video',
    },
  },
  'video-split': {
    localized: true,
    slugs: {
      en: 'split-a-video',
      es: 'dividir-un-video',
      'pt-BR': 'dividir-um-video',
      id: 'bagi-video',
      fr: 'decouper-une-video',
      de: 'video-teilen',
      ru: 'razdelit-video',
      tr: 'videoyu-bol',
      vi: 'chia-nho-video',
      it: 'dividere-un-video',
    },
  },
  'video-join': {
    localized: true,
    slugs: {
      ...
      'pt-BR': 'juntar-videos',
      id: 'gabung-video',
      fr: 'fusionner-des-videos',
      de: 'videos-zusammenfuegen',
      ru: 'obedinit-video',
      tr: 'videolari-birlestir',
      vi: 'ghep-video',
      it: 'unire-video',
    },
  },
  'video-frame': {
    localized: true,
    slugs: {
      en: 'save-a-frame-from-a-video',
      es: 'extraer-un-fotograma-de-un-video',
      'pt-BR': 'extrair-quadro-de-video',
      id: 'ambil-frame-dari-video',
      fr: 'extraire-une-image-dune-video',
      de: 'standbild-aus-video-speichern',
      ru: 'sokhranit-kadr-iz-video',
      tr: 'videodan-kare-kaydet',
      vi: 'luu-khung-hinh-tu-video',
      it: 'salvare-un-fotogramma-da-un-video',
    },
  },
  'video-gif': {
    localized: true,
    slugs: {
      ...
      'pt-BR': 'converter-video-em-gif',
      id: 'ubah-video-ke-gif',
      fr: 'convertir-une-video-en-gif',
      de: 'video-in-gif-umwandeln',
      ru: 'video-v-gif',
      tr: 'videoyu-gife-donustur',
      vi: 'chuyen-video-sang-gif',
      it: 'convertire-video-in-gif',
    },
  },
  'video-speed': {
    localized: true,
    slugs: {
      en: 'speed-up-a-video',
      es: 'acelerar-un-video',
      'pt-BR': 'acelerar-um-video',
      id: 'percepat-video',
      fr: 'accelerer-une-video',
      de: 'video-beschleunigen',
      ru: 'uskorit-video',
      tr: 'videoyu-hizlandir',
      vi: 'tang-toc-video',
      it: 'velocizzare-un-video',
    },
  },
  'video-reframe': {
    localized: true,
    slugs: {
      en: 'resize-video-for-reels-and-tiktok',
      es: 'cambiar-tamano-de-video-para-reels-y-tiktok',
      'pt-BR': 'redimensionar-video-para-reels-e-tiktok',
      id: 'ubah-ukuran-video-untuk-reels-dan-tiktok',
      fr: 'redimensionner-une-video-pour-reels-et-tiktok',
      de: 'video-fuer-reels-und-tiktok-anpassen',
      ru: 'izmenit-format-video-dlya-reels-i-tiktok',
      tr: 'videoyu-reels-ve-tiktok-icin-boyutlandir',
      vi: 'doi-kich-thuoc-video-cho-reels-va-tiktok',
      it: 'ridimensionare-video-per-reels-e-tiktok',
    },
  },
  'video-annotate': {
    localized: true,
    slugs: {
      en: 'add-text-and-arrows-to-a-video',
      es: 'anadir-texto-y-flechas-a-un-video',
      'pt-BR': 'adicionar-texto-e-setas-a-um-video',
      id: 'tambah-teks-dan-panah-ke-video',
      fr: 'ajouter-du-texte-et-des-fleches-a-une-video',
      de: 'text-und-pfeile-zu-einem-video-hinzufuegen',
      ru: 'dobavit-tekst-i-strelki-na-video',
      tr: 'videoya-yazi-ve-ok-ekle',
      vi: 'them-chu-va-mui-ten-vao-video',
      it: 'aggiungere-testo-e-frecce-a-un-video',
    },
  },
  'video-blur': {
    localized: true,
    slugs: {
      en: 'blur-a-face-in-a-video',
      es: 'difuminar-una-cara-en-un-video',
      'pt-BR': 'desfocar-rosto-em-video',
      id: 'blur-wajah-di-video',
      fr: 'flouter-un-visage-dans-une-video',
      de: 'gesicht-im-video-unscharf-machen',
      ru: 'razmyt-lico-na-video',
      tr: 'videoda-yuz-bulaniklastir',
      vi: 'lam-mo-khuon-mat-trong-video',
      it: 'sfocare-un-volto-in-un-video',
    },
  },
  'passport-photo': {
    localized: true,
...
const RELATED: Record<ToolKey, readonly ToolKey[]> = {
  ...
  'video-trim': ['video-split', 'video-speed', 'video-join'],
  'video-blur': ['video-annotate', 'redact', 'video-trim'],
  'video-annotate': ['video-blur', 'video-trim', 'image-watermark'],
  'video-reframe': ['video-trim', 'video-compress', 'image-crop'],
  'video-mute': ['video-extract-audio', 'video-trim', 'video-compress'],
  'video-extract-audio': ['video-mute', 'video-trim', 'video-compress'],
  'video-speed': ['video-trim', 'video-gif', 'video-compress'],
  'video-gif': ['video-trim', 'video-speed', 'video-frame'],
  'video-frame': ['video-gif', 'video-trim', 'image-crop'],
  'video-split': ['video-join', 'video-trim', 'video-compress'],
  'video-join': ['video-split', 'video-trim', 'video-reframe'],
