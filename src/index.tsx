...
const COMPONENTS: Record<RouteKey, Component> = {
  ...
  'video-annotate': lazy(() => import('./routes/tools/video-annotate')),
  'video-reframe': lazy(() => import('./routes/tools/video-reframe')),
  'video-mute': lazy(() => import('./routes/tools/video-mute')),
  ...
  'video-split': lazy(() => import('./routes/tools/video-split')),
  'video-join': lazy(() => import('./routes/tools/video-join')),
  ...
  'pdf-password': lazy(() => import('./routes/tools/pdf-password')),
